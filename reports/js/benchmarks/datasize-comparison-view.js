...
dsc.methodSelect = function()
{
  ...
  var sqlstr = "SELECT methods.parameters, results.libary_id FROM methods, results WHERE methods.name == '" + dsc.method_name + "' AND methods.id == results.method_id GROUP BY methods.parameters;";
