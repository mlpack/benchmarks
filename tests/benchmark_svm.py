'''
  ...
  Test for the Parametric Support Vector Classifier scripts.
'''
...
'''
Test the shogun Parametric Support Vector Classifier script.
'''
class SVC_SHOGUN_TEST(unittest.TestCase):
  ...
  def setUp(self):
    ...
    module = Loader.ImportModuleFromPath("methods/shogun/svm.py")
...
'''
Test the Scikit Parametric Support Vector Classifier script.
'''
class SVC_SCIKIT_TEST(unittest.TestCase):
