'''
  @file benchmark_local_coordinate_coding.py
  @author Marcus Edel

  Test for the Local Coordinate Coding scripts.
'''
...
'''
Test the mlpack Local Coordinate Coding script.
'''
class LocalCoordinateCoding_MLPACK_TEST(unittest.TestCase):
  ...
  def test_RunMethod(self):
    result = self.instance.RunMethod("-k 2")
  ...
  def test_RunMemoryProfiling(self):
    result = self.instance.RunMemoryProfiling("-k 2", "test.mout")
