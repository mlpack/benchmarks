'''
  @file benchmark_hmm_train.py
  @author Marcus Edel

  Test for the Hidden Markov Model Training scripts.
'''
...
'''
Test the mlpack Hidden Markov Model Training script.
'''
class HMMTRAIN_MLPACK_TEST(unittest.TestCase):
  ...
  def test_RunMethod(self):
    result = self.instance.RunMethod("-t gaussian -n 2")
  ...
  def test_RunMemoryProfiling(self):
    result = self.instance.RunMemoryProfiling("-t gaussian -n 2", "test.mout")
