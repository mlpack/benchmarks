'''
  @file benchmark_hmm_loglik.py
  @author Marcus Edel

  Test for the Hidden Markov Model Sequence Log-Likelihood scripts.
'''
...
'''
Test the mlpack Hidden Markov Model Sequence Log-Likelihood script.
'''
class HMMLOGLIK_MLPACK_TEST(unittest.TestCase):
