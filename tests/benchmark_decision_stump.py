...
'''
Test the weka Decision Stump Prediction script.
'''

class DecisionStump_WEKA_TEST(unittest.TestCase):
  ...
  def setUp(self):
    ...
    module = Loader.ImportModuleFromPath("methods/weka/decision_stump.py")
    obj = getattr(module, "DECISIONSTUMP")
    self.instance = obj(self.dataset, verbose=self.verbose, timeout=self.timeout)
