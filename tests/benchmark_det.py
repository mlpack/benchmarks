'''
  @file benchmark_det.py
  @author Marcus Edel

  Test for the Density Estimation With Density Estimation Trees scripts.
'''
...
'''
Test the mlpack Density Estimation With Density Estimation Trees script.
'''
class DET_MLPACK_TEST(unittest.TestCase):
  ...
  def setUp(self):
    ...
    module = Loader.ImportModuleFromPath("methods/mlpack/det.py")
    obj = getattr(module, "DET")
