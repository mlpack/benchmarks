...
class DECISIONTREE(object):
  ...
  @param dataset - Input dataset to perform Decision Tree Classification on.
  ...
  '''
  Build the model for the DecisionTree Classifier.
  ...
  '''
  Use the mlpy libary to implement the Decision Tree Classifier.
  ...
  def RunMetrics(self, options):
    Log.Info("Perform Classification using Tree.", self.verbose)

    results = None
    if len(self.dataset) >= 2:
      results = self.DCMlpy(options)
