'''
  @file qda.py
  Class to benchmark the R Quadratic Discriminant Analysis method.
'''
...
class QDA(object):
  ...
  '''
  QDA. If the method has been successfully completed return
  ...
  def RunMetrics(self, options):
    ...
    cmd = shlex.split("libraries/bin/Rscript " + self.path + "qda.r" +
        " -t " + self.dataset[0] + " -T " +
        self.dataset[1])
