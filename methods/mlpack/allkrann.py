...
class ALLKRANN(object):
	...
	# Create the All K-Rank-Approximate-Nearest-Neighbors instance, 
	...
	# Perform All K-Rank-Approximate-Nearest-Neighbors and return
	# the elapsed time.
	def RunMethod(self, options):
		...
		if len(self.dataset) == 2:
			cmd = shlex.split(self.path + "allkrann -r " + self.dataset[0] + 
				" -q " + self.dataset[1] + 
