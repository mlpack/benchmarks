...
class MLPACK_KPCA(object):
  def __init__(self, method_param, run_param):
    ...
    if "nystroem" in method_param:
      options += " --nystroem_method"
    if "sampling_scheme" in method_param:
      options += " -s " + str(method_param["sampling_scheme"])
