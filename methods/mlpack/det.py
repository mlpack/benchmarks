...
class DET(object):
	...
	# Create the Density Estimation With Density Estimation Trees instance, 
	...
	# Perform Density Estimation With Density Estimation Trees and return
	# the elapsed time.
	def RunMethod(self, options):
		...
		if len(self.dataset) == 2:
			...
			cmd = shlex.split(self.path + "det -t " + self.dataset + " -v " + 
				options)
