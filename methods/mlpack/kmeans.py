...
class KMeans(object):
	...
	# Create the K-Means Clustering instance, show some informations 
	...
	# Perform K-Means Clustering and return the elapsed time.
	def RunMethod(self, options):
		Log.Info('Perform K-Means Clustering.', self.verbose)

		# Split the command using shell-like syntax.
		cmd = shlex.split(self.path + "kmeans -i " + self.dataset + " -o output.csv -v " + options)
