...
class SVR(object):
  ...
  '''
  Create the Support Vector Regression benchmark instance.
  ...
  '''
  Support Vector Regression. If the method has been successfully completed return
  ...
  def RunMetrics(self, options):
    ...
    cmd = shlex.split(self.path + "matlab -nodisplay -nosplash -r \"try, SVR('"
